...
var client_id = "3ae4a784ff8b44ab9abab45f20cf8c01"; 
var client_secret = "ecbba464f3c44a16a5a2e9eb215cd9d9"; // Joooo tohle by rozhodně nikdo neměl vidět, ale kdo by se sem kouknul že? :)
...
function currentlyPlaying(){
    ...
    setTimeout(currentlyPlaying, 5000)
}
...
function handlePlay(){
    if ( this.status == 200 ){
        var data = JSON.parse(this.responseText);
        console.log(data);       
        let trackId = data.item.external_urls.spotify;
        document.getElementById("button").onclick = function () { 
            window.open(trackId, "_blank")
        }
    } 
}

function play(){
    callApi( "GET", PLAYER + "?market=US", null, handlePlay );
